...
import static com.bluebubbles.wearos.MainActivity.OPEN_CAMERA;
...
public class OpenCamera implements Handler{
    ...
    public void Handle() {
        ...
        try {
            ...
            Uri outputURI = FileProvider.getUriForFile(context, "com.bluebubbles.wearos.fileprovider", file);
