...
public class OpenFile implements Handler{
    ...
    public void Handle() {
        ...
        Uri data = FileProvider.getUriForFile(context, "com.bluebubbles.wearos.fileprovider", new File(context.getFilesDir().getAbsolutePath() + (String) call.argument("path")));
